...
| test suffix | CAPM3 branch | IPAM branch  | BMO branch/tag  | Keepalived tag | Ironic tag | IPA branch    |
| ----------- | ------------ | -----------  | --------------- | -------------- | ---------- | ------------- |
| main        | main         | main         | main            | latest         | latest     | master        |
| release-1-9 | release-1.9  | release-1.9  | release-0.9     | v0.9.0         | v27.0.0    | stable/2024.2 |
| release-1-8 | release-1.8  | release-1.8  | release-0.8     | v0.8.0         | v26.0.1    | stable/2024.2 |
| release-1-7 | release-1.7  | release-1.7  | release-0.6     | v0.6.2         | v24.1.2    | stable/2024.2 |
